...
//  Also, it is NOT required that the key value and mapped value pair has to be unique in
//   this case. One important thing to note about multimap is that multimap keeps all the
//    keys in sorted order always. These properties of multimap makes it very much useful
